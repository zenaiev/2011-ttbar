...
public:
    ...
    const KinematicReconstructionSolution& operator=(const KinematicReconstructionSolution& rhs){
      //printf("ass\n");
      return rhs;
    }

    /// Move operator (needed to allow std::vector<KinematicReconstructionSolution> with const data members)
    //const KinematicReconstructionSolution& operator=(KinematicReconstructionSolution&& rhs){
      //printf("move\n");
      //return rhs;
    //}
