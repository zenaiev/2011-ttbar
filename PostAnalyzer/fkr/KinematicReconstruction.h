...
public:
    ...
    KinematicReconstruction(const TString& fileInput, const int minNumberOfBtags, const bool preferBtags, const bool massLoop = false);
    ...
    void loadData(const TString& fileInput);
...
public:
    ...
    /// Constructor
    KinematicReconstructionScaleFactors(const Era::Era era,
