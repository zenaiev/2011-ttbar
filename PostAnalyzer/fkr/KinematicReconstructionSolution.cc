...
met_(kinematicReconstructionSolution.met_),
...
void KinematicReconstructionSolution::print()const
{
    ...
    std::cout<<"\t\tLepton (pt, eta, phi, mass):        "<<lepton.pt()<<" , "<<lepton.eta()<<" , "<<lepton.phi()<<" , "<<lepton.mass()<<"\n"
             ...
             <<"\t\tMET (pt, eta, phi, mass):           "<<met_.pt()<<" , "<<met_.eta()<<" , "<<met_.phi()<<" , "<<met_.mass()<<"\n";
    ...
    auto l_an = lepton + antiNeutrino_;
    std::cout<<"\t\t[l+an] (pt, eta, phi, mass):            "<<l_an.pt()<<" , "<<l_an.eta()<<" , "<<l_an.phi()<<" , "<<l_an.mass()<<"\n";
    auto al_an = antiLepton + antiNeutrino_;
    std::cout<<"\t\t[al+an] (pt, eta, phi, mass):           "<<al_an.pt()<<" , "<<al_an.eta()<<" , "<<al_an.phi()<<" , "<<al_an.mass()<<"\n";
    auto l_n = lepton + neutrino_;
    std::cout<<"\t\t[l+n] (pt, eta, phi, mass):             "<<l_n.pt()<<" , "<<l_n.eta()<<" , "<<l_n.phi()<<" , "<<l_n.mass()<<"\n";
    auto al_n = antiLepton + neutrino_;
    std::cout<<"\t\t[al+n] (pt, eta, phi, mass):            "<<al_n.pt()<<" , "<<al_n.eta()<<" , "<<al_n.phi()<<" , "<<al_n.mass()<<"\n";
    auto wm_b = wMinus + bjet;
    std::cout<<"\t\t[wm+b] (pt, eta, phi, mass):            "<<wm_b.pt()<<" , "<<wm_b.eta()<<" , "<<wm_b.phi()<<" , "<<wm_b.mass()<<"\n";
    auto wp_ab = wPlus + antiBjet;
    std::cout<<"\t\t[wp+ab] (pt, eta, phi, mass):           "<<wp_ab.pt()<<" , "<<wp_ab.eta()<<" , "<<wp_ab.phi()<<" , "<<wp_ab.mass()<<"\n";
    auto wp_b = wPlus + bjet;
    std::cout<<"\t\t[wp+b] (pt, eta, phi, mass):            "<<wp_b.pt()<<" , "<<wp_b.eta()<<" , "<<wp_b.phi()<<" , "<<wp_b.mass()<<"\n";
    auto wm_ab = wMinus + antiBjet;
    std::cout<<"\t\t[wm+ab] (pt, eta, phi, mass):           "<<wm_ab.pt()<<" , "<<wm_ab.eta()<<" , "<<wm_ab.phi()<<" , "<<wm_ab.mass()<<"\n";
    auto t_tb = top + antiTop;
    std::cout<<"\t\t[t+tb] (pt, eta, phi, mass):            "<<t_tb.pt()<<" , "<<t_tb.eta()<<" , "<<t_tb.phi()<<" , "<<t_tb.mass()<<"\n";
    auto n_an = neutrino_ + antiNeutrino_;
    std::cout<<"\t\t[n+an] (pt, eta, phi, mass):            "<<n_an.pt()<<" , "<<n_an.eta()<<" , "<<n_an.phi()<<" , "<<n_an.mass()<<"\n";
    auto l_al_b_ab = lepton + antiLepton + bjet + antiBjet + met_;
    std::cout<<"\t\t[l+al+b+ab+m] (pt, eta, phi, mass):     "<<l_al_b_ab.pt()<<" , "<<l_al_b_ab.eta()<<" , "<<l_al_b_ab.phi()<<" , "<<l_al_b_ab.mass()<<"\n";
}
